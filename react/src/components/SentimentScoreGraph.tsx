      ...
      fetch(
        ...
        .then((data: Record<string, string>[]) => {
          if (data.length > 0) {
            ...
            ).reduce((acc, [feedbackcategory, date_sentiment_scores]) => {
              acc[feedbackcategory] = Object.entries(date_sentiment_scores).map(
        ...
        >
          ...
          >
            ...
            <Select
              ...
              MenuProps={MenuProps}
            >
              {graphFeedbackcategories.map((feedbackcategory: string) => (
